...
@implementation ChatDrugTableViewCell
...
-(void)setModel:(ChatModel *)model{
    ...
    switch ([_model.user_type integerValue]) {
        ...
        case 0:{
            ...
            self.detailsButton.sd_resetLayout
            .bottomSpaceToView(self.contentBackView, 0)
            .widthIs(120)
            .heightIs(40)
            .leftSpaceToView(self.iconImageView, 15);

            self.drugContentView.sd_resetLayout
            .leftSpaceToView(self.iconImageView, 15)
            .widthIs(240)
            .topSpaceToView(self.contentView, 10)
            .bottomSpaceToView(self.contentView, 50);
            
            self.continueButton.sd_resetLayout
            .bottomSpaceToView(self.contentBackView, 0)
            .widthIs(120)
            .heightIs(40)
            .leftSpaceToView(self.detailsButton, 0);
        ...
        case 1:{
            ...
            .widthIs(120)
            .heightIs(40)
            .rightSpaceToView(self.continueButton, 0);
...
//    self.iconImageView.contentMode = UIViewContentModeScaleAspectFit;
    ...
    self.continueButton.titleLabel.font = [UIFont systemFontOfSize: 16];
    [self.continueButton setTitle:@"续方" forState:UIControlStateNormal];
    [self.continueButton setTitleColor:kMainColor forState:UIControlStateNormal];
    [self.continueButton setBackgroundColor: RGB(200, 209, 254)];
